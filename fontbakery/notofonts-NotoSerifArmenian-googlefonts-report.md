 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, syriac, malayalam, canadian-aboriginal, math, coptic, old-permic, tifinagh
 ...
 * U+2010 HYPHEN: try adding one of: kayah-li, syloti-nagri, coptic, sora-sompeng, sundanese, cham, yi, kaithi, lisu, kharoshthi
 * U+25CC DOTTED CIRCLE: try adding one of: sogdian, mongolian, tagbanwa, batak, gurmukhi, mende-kikakui, hanifi-rohingya, new-tai-lue, mahajani, newa, old-permic, tifinagh, yi, khmer, hebrew, thai, meetei-mayek, lepcha, bhaiksuki, cham, tamil, wancho, malayalam, bengali, kannada, tai-viet, rejang, manichaean, caucasian-albanian, miao, masaram-gondi, gunjala-gondi, coptic, tagalog, kaithi, syloti-nagri, math, takri, buhid, phags-pa, siddham, khudawadi, zanabazar-square, grantha, osage, nko, soyombo, myanmar, thaana, kharoshthi, khojki, tirhuta, duployan, music, limbu, syriac, psalter-pahlavi, tibetan, chakma, adlam, lao, mandaic, tai-le, modi, oriya, brahmi, javanese, pahawh-hmong, elbasan, gujarati, sundanese, dogra, hanunoo, symbols, balinese, ahom, kayah-li, bassa-vah, buginese, sharada, devanagari, telugu, marchen, sinhala
...
Your font does *not* cover the following languages that require the soft-dotted feature: Bete-Bendi (Latn, 100,000 speakers), Avokaya (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Belarusian (Cyrl, 10,064,517 speakers), South Central Banda (Latn, 244,000 speakers), Mango (Latn, 77,000 speakers), Fur (Latn, 1,230,163 speakers), Dan (Latn, 1,099,244 speakers), Zapotec (Latn, 490,000 speakers), Ebira (Latn, 2,200,000 speakers), Nzakara (Latn, 50,000 speakers), Ejagham (Latn, 120,000 speakers), Sar (Latn, 500,000 speakers), Igbo (Latn, 27,823,640 speakers), Koonzime (Latn, 40,000 speakers), Bafut (Latn, 158,146 speakers), Nateni (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Makaa (Latn, 221,000 speakers), Southern Kisi (Latn, 360,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Navajo (Latn, 166,319 speakers), Aghem (Latn, 38,843 speakers), Cicipu (Latn, 44,000 speakers), Basaa (Latn, 332,940 speakers), Ekpeye (Latn, 226,000 speakers), Mfumte (Latn, 79,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Kom (Latn, 360,685 speakers), Dii (Latn, 71,000 speakers), Lugbara (Latn, 2,200,000 speakers), Yala (Latn, 200,000 speakers), Mundani (Latn, 34,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers). [code: soft-dotted]
